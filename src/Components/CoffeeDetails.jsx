            ...
            <div className='bg-[#F4F3F0] p-11'>
                <div className='lg:flex items-center'>
                    ...
                    <div className='w-full'>
                        ...
                        <p className='text-[14px] mt-1'><span className='font-semibold'>Name: </span> {singleCoffee?.name}</p>
                        <p className='text-[14px] mt-1'><span className='font-semibold'>Chef: </span> {singleCoffee?.chef}</p>
